...
<head>
    ...
    <link href="../dairywebsite/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="../dairywebsite/css/style.css" rel="stylesheet">
</head>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="../dairywebsite/login_form.php" class="nav-item nav-link">Login</a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Pure, Local and Wholesome products prepared traditionally with love and responsibility</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Authentic</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Farm to Kitchen</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Sustainable</p>
        ...
        <div class="container">
            ...
            <div class="row gx-4">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="product-item">
                        <div class="position-relative">
                            ...
                            <a class="btn btn-square btn-secondary rounded-circle m-1" onclick="myFunction()"><i class="bi bi-cart"></i></a>
                            </div>
                        </div>
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Pure Milk</a>
                            <span class="text-primary me-1">₹60.00</span>
                            <span class="text-decoration-line-through">₹ 75.00</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/curd2.jpg"  alt="">
                            <div class="product-overlay">
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Fresh CURD</a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="text-decoration-line-through">₹600.00</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Vegetables</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Shop no.10, Dehuroad,PUNE</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>8010604135</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>MILKMART@gmail.com</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-semi-bold" href="#">MILKMART</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="fw-semi-bold" href="https://htmlcodex.com">Prathamesh Bhegade</a>
                </div>
            </div>
        </div>
    </div>
